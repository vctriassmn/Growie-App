...
const styles = StyleSheet.create({
    ...
    titleInput: { fontSize: 28, fontFamily: 'Nunito-ExtraBold', color: '#448461', borderBottomWidth: 1, borderBottomColor: '#ccc', paddingBottom: 8, textAlign: 'center', marginBottom: 0 },
    scrollContainer: { paddingBottom: 70 },
    richEditor: { minHeight: 650, flex: 1 },
    editToolbarWrapper: { position: 'absolute', bottom: 20, left: 0, right: 0, alignItems: 'center' },
